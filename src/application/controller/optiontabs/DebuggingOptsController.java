...
public class DebuggingOptsController implements Initializable {
  ...
  ObservableList<String> list1 =
      FXCollections.observableArrayList("Stabs", "DWARF", "COFF", "XCOFF");
  ObservableList<String> list2 =
      FXCollections.observableArrayList("Level0", "Level1", "Level2", "Level3");
